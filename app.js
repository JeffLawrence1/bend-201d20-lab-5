...
function sum(a, b) { //eslint-disable-line
  ...
  arr.push(sum1);
  console.log(arr);
  arr.push('The sum of ' + a + ' and ' + b + ' is ' + sum1 + '.');
  console.log(arr);
  return arr;
...
function multiply(a, b) { //eslint-disable-line
  ...
  arr.push(mult);
  console.log(arr);
  arr.push('The product of ' + a + ' and ' + b + ' is ' + mult + '.');
  console.log(arr);
  return arr;
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  arr.push(a + ' and ' + b + ' and ' + c + ' sum to ' + sum2[0] + '.');
  arr.push('The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + mult2[0] + '.');
  console.log(arr);
  return arr;
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for(var i = 0; i < dynamicArray.length - 1; i++){
    ...
    total = multiply(dynamicArray[i], dynamicArray[i + 1]);
  }
  arr.push(total);
  console.log(total);
  strin += dynamicArray;
  arr.push('The numbers ' + strin + ' have a product of ' + total + '.');
  return arr;
}
